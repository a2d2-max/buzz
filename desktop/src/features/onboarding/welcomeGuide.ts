...
export const WELCOME_GUIDE_INTRO_MESSAGE = `Hi, I'm Fizz. Welcome to ${BRAND_NAME}.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in ${BRAND_NAME}, or just talk through what you want to build.`;
