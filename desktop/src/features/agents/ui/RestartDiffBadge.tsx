 ...
 */
export const AUTO_RESTART_ON_BLURB = `Configuration changed since this agent started. ${BRAND_NAME} can restart it automatically after ~3 minutes idle, or stop and respawn it to apply now.`;
