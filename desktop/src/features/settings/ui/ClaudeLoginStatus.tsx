...
/**
 * Where an in-app Claude login stands, plus the two things the user can do
...
export function ClaudeLoginStatus({
  ...
  return (
    <div
      ...
      data-testid={`claude-account-login-status-${accountId}`}
    ...
    >
      ...
      {view.running && view.offerSignInLink ? (
        <Button
          ...
          data-testid={`claude-account-login-open-${accountId}`}
      ...
      {view.running || view.retryStopping ? (
        <Button
          ...
          data-testid={
            view.retryStopping
              ? `claude-account-login-retry-stop-${accountId}`
              : `claude-account-login-cancel-${accountId}`
          }
