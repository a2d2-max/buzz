...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": `${BRAND_NAME}'s built-in agent runtime, bundled with the app.`,
  ...
  cursor: `Cursor's coding agent, connected to ${BRAND_NAME} through its ACP server.`,
  ...
  grok: `xAI's coding agent, connected to ${BRAND_NAME} through its ACP entrypoint.`,
