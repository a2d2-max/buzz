...
pub(super) const PRESET_HARNESSES: &[PresetHarness] = &[
    ...
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Devin through the official Devin CLI's ACP mode (devin acp).",
        underlying_cli: None,
    ...
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Cursor through the cursor-agent CLI's ACP mode.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Oh My Pi through its CLI's ACP mode (omp acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Grok Build through its CLI's agent stdio mode.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to OpenCode through its CLI's ACP mode (opencode acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Kimi Code through its CLI's ACP mode (kimi acp).",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to the Amp CLI through the amp-acp adapter. Follow the setup guide to install the adapter so the amp-acp command is on your PATH.",
    ...
    PresetHarness {
        ...
        install_hint: "a2d2 talks to Hermes Agent through its hermes-acp command.",
        underlying_cli: None,
        underlying_cli_install_hint: None,
        underlying_cli_install_instructions_url: None,
    },
    PresetHarness {
        ...
        install_hint: "a2d2 talks to OpenClaw through its ACP mode (openclaw acp), which relies on the OpenClaw Gateway daemon. Follow the setup guide to install both.\n\n\
